...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/PMbollywoodMovies'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/PicashowMoviesRequestGroup')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴊᴏɪɴ ᴍʏ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url="https://t.me/PicashowMoviesRequestGroup")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
